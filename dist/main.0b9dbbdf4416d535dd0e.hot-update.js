...
const PinIcon = Object(_mui_material_styles__WEBPACK_IMPORTED_MODULE_2__["styled"])(_mui_icons_material__WEBPACK_IMPORTED_MODULE_3__["CircleTwoTone"])(_ref => {
  let {
    theme,
    type
  } = _ref;
  return {
    color: type === PinType.IO ? 'primary' : type === PinType.POWER ? 'action' : 'disabled'
  };
});
function Deposits() {
...
//# sourceMappingURL=main.0b9dbbdf4416d535dd0e.hot-update.js.map